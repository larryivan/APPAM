...
ADDITIONAL_TOOLS = [
    ...
    },
    {
        ...
        'notes': [
            ...
            'Requires Snakemake on PATH plus configured MetaWRAP/PyDamage environments and CheckM/GUNC databases.',
        ...
        'parameters': [
            ...
            {'name': 'checkm_db', 'description': 'Override CheckM database path (optional)', 'type': 'string'},
